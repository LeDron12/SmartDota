...
class PublicMatchesDataloader(BaseDataloader):
    ...
    def __init__(self, 
                 patch_timestamp_start: int, # 1703278800 (23 dec 2023) - 7.35b | 1739998800 - 7.38 start, 1740776400 - 7.38 ok
                 patch_timestamp_end: int, # 1708549200 (23 feb 2023) - 7.35c | 1746392400 - 7.38
                 num_threads: int=4,
                 batch_size: int=90,
                 verbose: bool=False, 
                 debug: bool=False, 
                 use_key: bool=False,
                 first_id: int=9999999998
                 ) -> None:
